...
sealed abstract class AbstractLeft<L, R> extends AbstractEither<L, R, L>
    ...
    /**
     * The non-serializable super class of a "Serializable" class (e.g. {@link eu.infolead.jtk.fp.either.Maybe.Some}
     * and {@link eu.infolead.jtk.fp.either.Maybe.None}) should have a no-argument constructor
     * <p>
